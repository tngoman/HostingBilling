<div class="modal-dialog">
	<div class="modal-content">
		...
		<h4 class="modal-title"><?=lang('delete_account')?></h4>
		</div><?php
		...
		<button <?=(config_item('demo_mode') == 'TRUE') ? 'disabled' : ''?> type="submit" class="btn btn-<?=config_item('theme_color');?>"><?=lang('delete_account')?></button>
		</form>
		</div>
	</div>
	<!-- /.modal-content -->
