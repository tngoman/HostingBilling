 ...
 */
class FulfilledPromise implements \_PhpScoper5ed105407e8f2\GuzzleHttp\Promise\PromiseInterface
{
    private $value;
    ...
    public function then(callable $onFulfilled = null, callable $onRejected = null)
    {
        ...
        $queue = queue();
        $p = new \_PhpScoper5ed105407e8f2\GuzzleHttp\Promise\Promise([$queue, 'run']);
        $value = $this->value;
