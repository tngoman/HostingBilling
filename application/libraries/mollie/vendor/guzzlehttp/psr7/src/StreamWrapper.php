...
class StreamWrapper
{
     ...
     */
    public static function getResource(\_PhpScoper5ed105407e8f2\Psr\Http\Message\StreamInterface $stream)
    {
        self::register();
     ...
     * @return resource
     */
    public static function createStreamContext(\_PhpScoper5ed105407e8f2\Psr\Http\Message\StreamInterface $stream)
    {
